...
const Login = () => {
    ...
    <img src={assets.profile_icon} alt="Profile Icon" className="w-10 h-10 rounded-full"/>
        <input type="text" className='outline-none text-sm' placeholder='Full Name' required/>
    </div>}

    <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
    <img src={assets.email_icon} alt="Profile Icon" className="w-10 h-10 rounded-full"/>
        <input type="email" className='outline-none text-sm' placeholder='Email ID' required/>
    </div>

    <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
    <img src={assets.lock_icon} alt="Profile Icon" className="w-10 h-10 rounded-full"/>
